...
//                     createdAt: new Date(),
//                 });
//                 productcontext.setProducts((abc) => [...abc, { id: newproduct.id, ...product }]);
//                 setProduct({
//                     productname: "",
//                     description: "",
//                     price: "",
...
//         setVisible((e) => ({
//             ...e,
//             editproduct: !e.editproduct,
//         }));

//         productcontext.setProducts((itm) =>
//             itm.map((abc) =>
//                 abc.id === editedProduct.id ? { ...editedProduct } : abc
//             )
//         );
//         setVisible((prev)=>({
//             ...prev,
...
//         const remaining = productcontext.products?.filter((abc) => abc.id !== itm.id);
//         productcontext.setProducts(remaining);
//     };
